  ...
  return (
    <section className='section'>
      ...
      >
        ...
        {/* Cards */}
        <div className='flex flex-col lg:flex-row lg:gap-x-[30px] gap-y-[30px] lg:gap-y-0 justify-center items-center text-'>
                ...
                >
                  <div 
                    ...
                    className={`${
                      ...
                      w-[300px] h-[500px] rounded-[12px] p-[40px] cursor-pointer transition-all bg-white`}
                  >
                    {/* Card Title Row */}
                    ...
                    <div className='flex flex-col gap-y-2 mb-6'>
                      ...
                      <div className='mb-10 py-4'>
                        <div className='flex justify-start'>
                          ...
                          <span className='text-2xl text-light font-light'> Month </span>
                        </div>
                      </div>
                    </div>
